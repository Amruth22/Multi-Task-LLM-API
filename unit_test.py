...
class TestMultiTaskLLMAPI(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.base_url = f"http://localhost:{cls.test_port}/api/v1"
        ...
        print(f"[SUCCESS] Test server started at {cls.base_url}")
    ...
    def _run_server(cls):
        ...
        try:
            ...
            app.run(host='localhost', port=cls.test_port, debug=False, use_reloader=False, threaded=True)
    ...
    def test_01_env_api_key_configured(self):
        ...
        print("\n[TEST] Testing API Key Configuration...")
        ...
        print(f"[SUCCESS] API Key configured: {api_key[:10]}...{api_key[-5:]}")
        
    def test_02_flask_app_initialization(self):
        """Test Flask app and extensions initialization"""
        print("\n[TEST] Testing Flask App Initialization...")
    ...
    def test_03_generate_text_endpoint(self):
        ...
        print("\n[TEST] Testing Text Generation Endpoint...")
        ...
        print(f"[SUCCESS] Text generated: {data['generated_text'][:50]}...")
        
    def test_04_generate_code_endpoint(self):
        """Test the /api/v1/generate/code endpoint"""
        print("\n[TEST] Testing Code Generation Endpoint...")
        ...
        print(f"[SUCCESS] Code generated: {data['generated_code'][:50]}...")
        
    def test_05_classify_text_endpoint(self):
        """Test the /api/v1/classify/text endpoint"""
        print("\n[TEST] Testing Text Classification Endpoint...")
        ...
        print(f"[SUCCESS] Text classified as: {data['classification']}")
    ...
    def test_07_direct_wrapper_functions(self):
        ...
        print("\n[TEST] Testing Wrapper Functions Directly...")
        ...
        print(f"[SUCCESS] Direct text generation: {text_result[:30]}...")
        ...
        print(f"[SUCCESS] Direct code generation: {code_result[:30]}...")
        ...
        print(f"[SUCCESS] Direct text classification: {classification_result}")
    
    def test_08_swagger_documentation(self):
        """Test Swagger UI accessibility"""
        print("\n[TEST] Testing Swagger Documentation...")
        
        # Test swagger endpoint
        swagger_url = f"http://localhost:{self.test_port}/swagger/"
        ...
        print(f"[SUCCESS] Swagger UI accessible at {swagger_url}")
    ...
    def test_09_rate_limiting(self):
        ...
        print(f"[SUCCESS] Rate limiting test completed - {success_count}/{len(responses)} requests succeeded")

if __name__ == '__main__':
    print("Starting Multi-Task LLM API Unit Tests (Windows Compatible)...")
    print(f"Testing against live server on dynamic port")
    ...
    if result.wasSuccessful():
        ...
        print(f"Live server tested at: http://localhost:8080")
        print(f"Swagger UI: http://localhost:8080/swagger/")
    else:
